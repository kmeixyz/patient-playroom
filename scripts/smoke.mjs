...
const required = ['Patient Playroom home', 'Make room for', 'Robot Route', 'New · Featured game', 'Bubble Pop', 'Play settings', 'Sky Dash', 'Match Club', 'Three in a Row', 'Maze Quest', 'Critter Café', 'Silly Studio', 'Pocket Garden', 'Puzzle Postcards', 'Turn sound on', 'My appointment']
