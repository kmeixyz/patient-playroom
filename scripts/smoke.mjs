...
const required = ['Patient Playroom home', 'Make room for', 'Robot Route', 'New · Featured game', 'Sky Dash', 'Orbit Pop', 'Match Club', 'Three in a Row', 'Maze Quest', 'Beat Garden', 'Turn sound on', 'My appointment']
